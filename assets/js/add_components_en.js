            ...
            <nav class="d-flex py-4" id="navbar">
                ...
                <div class="d-flex justify-content-between text-uppercase " id="dropdown_enabler">
                    <ul class="d-flex justify-content-between align-items-center" id="navbar_items">
                        ...
                        <li><h3 class="my-auto me-5  py-1 navbar_heading position-relative"
                                id="online"><a
                                href="online-beratung">CSN <span class="font_bold">Online Consulting</span></a></h3>
                        </li>
                        <li><h3 class="font_bold my-auto py-1 navbar_heading position-relative" id="warum"><a
                                href="warum">Why CSN</a></h3></li>
                    </ul>
                </div>
                <div class="d-flex my-auto align-items-center text-uppercase" id="icon_section_navbar">
                    <div class="d-flex flex-column  pe-5 icon" id="kontakt_nav_section">
                        ...
                        <p class="mx-auto no_padding_bot font_navbar font_medium"><a href="contact">Contact</a></p>
                    </div>
                    <div class="d-flex flex-column align-content-center pe-5 icon" id="suche">
                        <div class="mx-auto icons_height icon_jump">
                            <i data-feather="search"></i>
                        </div>
                        <p class="mx-auto no_padding_bot font_navbar font_medium">Search</p>
                    </div>
                    <div class="d-flex flex-column align-content-center icon">
                        <div class="mx-auto icons_height icon_jump">
                            <i data-feather="globe"></i>
                        </div>
                        <p class="mx-auto no_padding_bot font_navbar font_medium">German</p>
                    </div>
                </div>
        ...
        <div id="dropdown_bar">
            <div class="hide dropdown bg-white" id="dropdown_conferencing">
                <div class="box border-top d-flex justify-content-center py-3">
                    <h3 class="mx-5 dropdown_font"><a href="conferencing#conference_einsatz">Included products</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="conferencing#Einsatzbereiche">Use cases</a>
                    </h3>
                    <h3 class="mx-5 dropdown_font"><a href="conferencing#branchen">Branchen</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="conferencing#highlights">Our highlights</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="conferencing#features">Presentation features</a></h3>
                </div>
            </div>
            <div class="hide dropdown bg-white" id="dropdown_online">
                <div class="box border-top d-flex justify-content-center py-3 ">
                    <h3 class="mx-5 dropdown_font"><a href="online-beratung#trend">Trend to reality</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="online-beratung#highlights">Our highlights</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="online-beratung#features">More features</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="online-beratung#branchen">Branchen</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="online-beratung#sicherheit">Security</a></h3>
                </div>
            </div>
            <div class="hide dropdown bg-white" id="dropdown_warum">
                <div class="box border-top d-flex justify-content-center py-3">
                    ...
                    <h3 class="mx-5 dropdown_font"><a href="warum#sicherheit">Security & service</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="warum#umwelt">Environment & efficiency</a></h3>
                    <h3 class="mx-5 dropdown_font"><a href="warum#leitlinien">CSN vision</a></h3>
                </div>
            </div>
            <div class="hide dropdown bg-white" id="dropdown_suche">
                ...
                <p class="no_padding_bot f-14 my-auto ">Search term not found, please try again!</p>
    ...
    <div class="bg-primary py-2 box_navbar_top">
        <div class="box-right d-flex justify-content-between box-right ps-lg-3 text-uppercase text-white">
            <div class="" onclick="kostenlos_beides()">
                <span class="font_navbar font-regular me-3">Did we spark your interest?</span>
                <a href="kontakt"><span class="font_navbar font_bold arrow_after" >Free trial</span></a>
            </div>

            <div class="">
                <span class="font_navbar font-regular me-3">Already registered?</span>
...
<div class="overlay hide" id="overlay">
    <div class="cookie position-fixed d-flex justify-content-between">
        <div class=" d-flex flex-column overflow-hidden cookie_between font_medium">
            <div class="d-flex">
                <span>We are using cookies to optimize your experience on our Website!</span>
            </div>
            ...
            <div>
                <div class="form-check form-switch my-3 d-flex">
                    ...
                    <label class="form-check-label my-auto" for="flexSwitchCheckChecked">Necessary Cookies</label>
                </div>
                <div class="form-check form-switch my-3 d-flex">
                    <input class="form-check-input shadow-none width_cookie me-3 my-auto" type="checkbox" checked>
                    <label class="form-check-label my-auto">Statistical Cookies</label>
                </div>
                <div class="form-check form-switch my-3 d-flex">
                    <input class="form-check-input shadow-none width_cookie me-3 my-auto" type="checkbox">
            ...
            <div class="d-flex flex-column">
                <button type="button" class="button_cookie accept_all my-3 text-uppercase" id="all_cookies">Accept selected cookies
                </button>
                <button type="button" class="button_cookie accept_functional text-uppercase" id="functional_cookies">Allow only necessary cookies
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="box position-relative" id="footer">
        <div class="row py-5 no_gutter_x ">
            ...
            <div class="col-auto ms-auto col-xxl-3 d-flex footer_last_column order-1  order-xxl-2">
                <button class="button blue_full_button" onclick="kostenlos_beides()">Free Trial</button>
                <div class="flex-column my-auto justify-content-end icon ms-4 d-none d-lg-block">
                    ...
                    <span class="text-white no_padding_bot text-uppercase mx-auto font_medium font_navbar">German</span>
                </div>
            </div>
        </div>
        <div class="row py-5 top_border no_gutter_x">
            <div class="col-xl-3 col-lg-4 col-6 text-white ps-0 pe-3">
                ...
                <div class="font_light">
                    <p class="font_medium footer_list"><a href="conferencing#produkte">Included products</a></p>
                    <p class="font_light footer_list"><a
                            href="conferencing#Telefonkonferenzen">Telephone conferencíng</a></p>
                    <p class="font_light footer_list"><a href="conferencing#Webinare">Webinar & Online
                        Training</a></p>
                    <p class="font_light footer_list"><a href="conferencing#Webkonferenzen">Web conferencing</a></p>
                    <p class="font_light footer_list"><a href="conferencing#Videokonferenzen">Video conferencing</a>
                    </p>
                    <p class="font_light footer_list"><a href="conferencing#Operatorkonferenzen">Operator based conferencing
                   </a></p>
                </div>

                <div class="font_light pt-4">
                    <p class="font_medium footer_list"><a href="conferencing#Einsatzbereiche">Uses cases</a>
                    </p>
                    <p class="font_light footer_list"><a href="conferencing#Marketing">Marketing & Sales</a>
                    </p>
                    <p class="font_light footer_list"><a href="conferencing#Schulung">Education & Training</a></p>
                    <p class="font_light footer_list"><a href="conferencing#Business-Konferenzen">Business conferences</a>
                    </p>
            ...
            <div class="col-xl-3 col-lg-4 col-6 text-white pe-3">
                <p class="text-uppercase pb-2 font_bold primary">Csn online consulting</a></p>
                <div class="font_light">
                    <p class="font_medium footer_list"><a href="online-beratung#highlights">Product features</a>
                    </p>
                    <p class="font_light footer_list"><a href="online-beratung#highlights">Video counseling</a></p>
                    <p class="font_light footer_list"><a href="online-beratung#highlights">Text and videochat</a>
                    </p>
                    <p class="font_light footer_list"><a href="online-beratung#highlights">Digital
                        Signature</a></p>
                    <p class="font_light footer_list"><a href="online-beratung#highlights">File release &
                        Mediathek</a></p>
                    <p class="font_light footer_list"><a href="online-beratung#highlights">Surveys</a></p>
                </div>

                <div class="font_light pt-4">
                    <p class="font_medium footer_list"><a href="online-beratung#branchen">Branchen</a></p>
                    <p class="font_light footer_list"><a href="online-beratung#Versicherungen">Insurance companies &
                        brokers</a></p>
                    <p class="font_light footer_list"><a href="online-beratung#Banken">Banks & financial instituions</a></p>
                    <p class="font_light footer_list"><a href="online-beratung#Einzelhandel">Retail /
                        e-commerce</a></p>
                    <p class="font_light footer_list"><a href="online-beratung#Gesundheit">Healthcare</a>
                    </p>
                    <p class="font_light footer_list"><a href="online-beratung#Telekommunikation">Telecommunication</a>
                    </p>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-6 text-white mt-5 mt-lg-0 pe-3">
                <p class="text-uppercase pb-2 font_bold primary">Why CSN</p>
                <div class="font_light">
                    <p class="font_medium footer_list"><a href="warum#kriterien">Highlights</a></p>
                    <p class="font_light footer_list"><a href="warum#markterfahrung">20 years of experience</a></p>
                    <p class="font_light footer_list"><a href="warum#webtechnologien">Advanced web technologies</a></p>
                    <p class="font_light footer_list"><a href="warum#inhouse_service">In-house customer service</a></p>
                    <p class="font_light footer_list"><a href="warum#kostenlose_schulung">free briefing & consultation</a>
                    </p>
                    <p class="font_light footer_list"><a href="warum#premium_service">Premium operator service</a></p>
                </div>

                <div class="font_light pt-4">
                    <p class="font_medium footer_list"><a href="warum#sicherheit">About us</a></p>
                    <p class="font_light footer_list"><a href="warum#umwelt">Our vision</a></p>
                    <p class="font_light footer_list"><a href="warum#leitlinien">CSN guidelines</a></p>
                    <p class="font_light footer_list"><a href="warum#sicherheit">Made and hosted in Germany</a>
                    </p>
                    <p class="font_light footer_list"><a href="warum#sicherheit">certified and secure</a></p>
                    <p class="font_light footer_list"><a href="warum#sicherheit">DSGVO-, BDSG- and TKG-complient</a>
                    </p>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-6 d-flex flex-column justify-content-between text-white mt-md-5 mt-xl-0">
                <div>
                    <p class="text-uppercase primary pb-2 font_bold">Service menu</p>
                    <div class="font_light">
                        <p class="font_light footer_list special_child"><a href="impressum">Legal notice</a></p>
                        <p class="font_light footer_list"><a href="datenschutz">Privacy Policy</a></p>
                        <p class="font_light footer_list"><a href="impressum#haftung">Exclusion of liability</a></p>
                        <p class="font_light footer_list"><a href="agb">Terms and conditions</a></p>
                        <p class="font_light footer_list"><a href="kontakt">Contact</a></p>
                    </div>
                </div>
                <div class="mt-xl-0 mt-5 mt-xl-0">
                    <div class="font_light pb-3">
                        <p class="font_medium text-uppercase no_padding_bot">Share us via</p>
...
<section class="bg-primary position-relative overflow-hidden">
    <div class="box py-5 my-5 ">
        ...
        <h4 class="text-white text-center font_medium mx-sm-5" style="font-size: 30px; line-height: 1.8">Contact us and talk to one of our experts!</h4>
        <div class="row justify-content-between align-content-center d-flex text-white pt-5">
            ...
            <div class="col-12 col-lg-4 d-flex flex-column pt-3 mt-5 mt-lg-0 icon_footer">
                ...
                <p class="text-center pt-3 footer_heading font_light"><a href="kontakt">Contact us</a></p>
                <img src="/assets/pictures/line_white.png" alt="" class="align-self-center pt-2">
            </div>
            <div class="col-12 col-lg-4 d-flex flex-column pt-3 mt-5 mt-lg-0 icon_footer">
                <div class="height-contact d-flex justify-content-center icon_jump">
...
<section class="bg-secondary d-md-none overflow-hidden">
    <div class="box">
        <div class="d-flex flex-column w-100 pt-5">
            <button class="button blue_full_button" onclick="kostenlos_beides()">Free trial / test for free</button>
    ...
    <div class="d-flex w-100 flex-column mobile_footer_row mt-3">
        <div class="footer_accordion" id="mobile_footer_accordion">
            <div class="footer_item position-relative" id="footer_one">
                ...
                <div id="footer_conferencing" class="accordion-collapse mobile_footer_expand collapse"
                    ...
                    <div class="font_light">
                        <p class="font_medium footer_list"><a href="/conferencing#produkte">Included products</a>
                        </p>
                        <p class="font_light footer_list"><a href="/conferencing#Telefonkonferenzen">Telephone conferencing</a>
                        </p>
                        <p class="font_light footer_list"><a href="/conferencing#Webinare">Webinar & online
                            training</a></p>
                        <p class="font_light footer_list"><a href="/conferencing#Webkonferenzen">Web conferencing</a>
                        </p>
                        <p class="font_light footer_list"><a
                                href="conferencing#Videokonferenzen">Video conferencing</a></p>
                        <p class="font_light footer_list"><a href="/conferencing#Operatorkonferenzen">Operator based
                            conferences</a></p>
                    </div>

                    <div class="font_light pt-4">
                        <p class="font_medium footer_list"><a
                                href="/conferencing#Einsatzbereiche">Use cases</a></p>
                        <p class="font_light footer_list"><a href="/conferencing#Marketing">Marketing &
                            Sales</a></p>
                        <p class="font_light footer_list"><a href="/conferencing#Schulung">Training & Education</a>
                        </p>
                        <p class="font_light footer_list"><a href="/conferencing#Business-Konferenzen">Business Conferences</a>
                        </p>
                        <p class="font_light footer_list"><a href="/conferencing#Investor">Investor Relations
            ...
            <div class="footer_item position-relative" id="footer_two">
                <h2 class="no_padding_bot">
                    <button class="w-100 footer_button collapsed font_bold" type="button" data-bs-toggle="collapse"
                        ...
                        CSN online consulting <i data-feather="plus" class="footer_expand_icon"></i>
                    </button>
                </h2>
                <div id="footer_online" class="accordion-collapse mobile_footer_expand collapse"
                    ...
                    <div class="font_light">
                        <p class="font_medium footer_list"><a
                                href="/online-beratung#highlights">Product features</a></p>
                        <p class="font_light footer_list"><a href="/online-beratung#highlights">Video counseling</a>
                        </p>
                        <p class="font_light footer_list"><a href="/online-beratung#highlights">Text and
                            videochat</a></p>
                        <p class="font_light footer_list"><a href="/online-beratung#highlights">Digital
                            signature</a></p>
                        <p class="font_light footer_list"><a href="/online-beratung#highlights">File release &
                            mediathek</a></p>
                        <p class="font_light footer_list"><a href="/online-beratung#highlights">Polls</a></p>
                    </div>

                    <div class="font_light pt-4">
                        <p class="font_medium footer_list"><a href="/online-beratung#branchen">Branchen</a></p>
                        <p class="font_light footer_list"><a href="/online-beratung#Versicherungen">Insurance companies and brokers</a></p>
                        <p class="font_light footer_list"><a href="/online-beratung#Banken">Banks & Financial Instituions</a>
                        </p>
                        <p class="font_light footer_list"><a href="/online-beratung#Einzelhandel">Retail /
                            e-commerce</a></p>
                        <p class="font_light footer_list"><a
                                href="/online-beratung#Gesundheit">Healthcare</a></p>
                        <p class="font_light footer_list"><a href="/online-beratung#Telekommunikation">Telecommunication</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="footer_item position-relative" id="footer_three">
                ...
                <div id="footer_warum" class="accordion-collapse mobile_footer_expand collapse"
                    ...
                    <div class="font_light">
                        <p class="font_medium footer_list"><a href="/warum#kriterien">Highlights</a></p>
                        <p class="font_light footer_list"><a href="/warum#markterfahrung">20 years of experience</a>
                        </p>
                        <p class="font_light footer_list"><a href="/warum#webtechnologien">Advanced web technologies</a>
                        </p>
                        <p class="font_light footer_list"><a href="/warum#inhouse_service">In-house customer service</a></p>
                        <p class="font_light footer_list"><a href="/warum#kostenlose_schulung">Free briefing & consultation</a></p>
                        <p class="font_light footer_list"><a href="/warum#premium_service">Premium operator service</a>
                        </p>
                    </div>

                    <div class="font_light pt-4">
                        <p class="font_medium footer_list"><a href="/warum#sicherheit">About us uns</a></p>
                        <p class="font_light footer_list"><a href="/warum#umwelt">Our vision</a></p>
                        <p class="font_light footer_list"><a href="/warum#leitlinien">CSN Guidelines</a></p>
                        <p class="font_light footer_list"><a href="/warum#sicherheit">Made and hosted in
                            Germany</a></p>
                        <p class="font_light footer_list"><a href="/warum#sicherheit">certified and secure</a>
                        </p>
                        <p class="font_light footer_list"><a href="/warum#sicherheit">DSGVO-, BDSG- and
                            TKG-complient</a></p>
                    </div>
                </div>
            </div>
        ...
        <div class="box service_menu_footer position-relative">
            ...
            <div class="footer_service_container">
                <div>
                    <p class="text-uppercase primary pb-2 font_bold" id="service_heading">Service menu</p>
                ...
                <div class="mt-xl-0 mt-5 mt-xl-0">
                    <div class="pb-3">
                        <p class="font_bold text-uppercase text-white no_padding_bot share">Share this site via</p>
                        <div class="d-flex flex-wrap social_media_footer">
                            <a href="#" onclick="facebook()">
                                <div class="me-3 mt-3 social_media_row" >
                                    <i data-feather="facebook" class="icon-32"></i>
        ...
        <div>
                ...
                <div class="d-flex mobile_icon_container">
                    <a href="kontakt" id="mobile_kontakt_nav_section">
                        <div class="d-flex flex-column align-items-center me-4">
                            ...
                            <span class="font_medium text-uppercase mobile_nav_text mt-2">Contact</span>
                        </div>
                    </a>
                    <div class="d-flex flex-column align-items-center me-4" onclick="search_trigger()">
                        <i data-feather="search"></i>
                        <span class="font_medium text-uppercase mobile_nav_text mt-2">Search</span>
                    </div>
                    <div class="d-flex flex-column align-items-center" id="mobile_nav_deutsch">
                        <i data-feather="globe"></i>
                        <span class="font_medium text-uppercase mobile_nav_text mt-2">German</span>
                    </div>
            ...
            <div class="mobile_search_container hide" id="mobile_search_bar">
             <div class="w-100 pt-4 d-flex justify-content-center align-items-center hide_error navigation_inner_box" id="mobile_error">
                    <p class="f-14 no_padding_bot">Search term not found, try again!</p>
</div>
            ...
            <div class="navigation_inner_box">
                <ul class="mobile_nav_items">
                    <li><a href="index" class="font_bold" id="mobile_home">Home</a></li>
                    <li><a href="conferencing" id="mobile_conferencing">CSN <span class="font_bold">conferencing</span></a></li>
                    <li><a href="online-beratung" id="mobile_online">CSN <span class="font_bold">online consulting</span></a></li>
                    <li><a href="warum" class="font_bold" id="mobile_warum">Why CSN</a></li>
                </ul>
            </div></div>
            <div class="d-flex flex-column navigation_inner_box" id="social_media_nav">
                <h3 class="font_bold f-18 text-uppercase share">Share this site via</h3>
